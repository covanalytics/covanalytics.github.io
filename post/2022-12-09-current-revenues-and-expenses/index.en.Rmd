...
tags:
  - Finance
type: ''
subtitle: 'Annual Comprehensive Financial Report'
image: 'img/revenue-expenses.jpg'
---
...
ggplot(aes(x=`Fiscal Year`, y = Amount, fill = Type, label = Amount_))+
  ...
  labs(subtitle = "Current Revenues & Expenses", caption = "Source: Covington Finance Department\nDebt service and capital outlay not included")+
