...
The animation below shows the month-to-month location and magnitude (larger and brighther red dots equal more calls) of motorist assistance responses by the Covington Police. Instances with two dots displayed on the I-75 bridge indicate different call volumes for North and South directions on the Brent Spence Bridge. 

![](motorist_assists.gif)

# Time and Day of Week

The heatmap below shows how often the Covington Police respond to motorist assistance calls by weekday and hour.  Weekday afternoons and early evenings appear to be when motorists need police assistance most often, especially on Fridays.
...
plot_labels <-  labs(x = "Hour", 
                     ...
                     subtitle = "Counts by Weekday and Hour: January 2021 - July 2023",
                     caption = "Police\nCity of Covington\n CovData | 2023")
...
plot_labels <-  labs(x = "Hour", 
                     y = "", 
                     title = "Motorist Assists by Covington Police",
                     subtitle = "Seasonal Counts by Weekday and Hour: January 2021 - July 2023",
                     caption = "Police\nCity of Covington\n CovData | 2023")
...
plot_labels <-  labs(x = "Weekday", 
                     y = "", 
                     title = "Motorist Assists on I-75 Bridge by Covington Police",
                     subtitle = "Weekday Counts: January 2021 - July 2023",
                     caption = "Police\nCity of Covington\n CovData | 2023")
